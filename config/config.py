...
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6136633222").split())
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ITS-LUCKY-BOY/AlishaMusic",
)
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/WorldFriends_143")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/ITS-LUCKY-BOY/AlishaMusic")
